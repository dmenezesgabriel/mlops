...
sending ``X-Amz-Target: AmazonAthena.ListEngineVersions`` over real HTTP and
parsing the shaped error back out of the JSON-1.1 response.
"""
...
def test_botocore_parses_shaped_error_from_live_server(
    ...
    assert "ListEngineVersions" in response["Error"]["Message"]
