...
from ssg_syntax_highlighting.application.syntax_highlighter import CodeSyntaxHighlighter
...
class PygmentsCodeSyntaxHighlighter(CodeSyntaxHighlighter):
    def __init__(self, style_name: str) -> None:
        ...
        self._formatter = HtmlFormatter(nowrap=True, noclasses=True, style=style_name)
    ...
    def highlight(self, source: str, language: str) -> str:
        ...
        return highlighted_source.replace("<span ", '<span class="highlight-token" ')
    ...
    def _lexer_for_language(self, language: str) -> Lexer:
        try:
            ...
            LOGGER.info(
                ...
                extra={"context": {"language": language, "style": self._style_name}},
            )
            return lexer
