...
from {{ cookiecutter.project_slug }}.inference.api import app


@patch("{{ cookiecutter.project_slug }}.inference.api._model")
@patch("{{ cookiecutter.project_slug }}.inference.api.fetch_online_features")
...
@patch("{{ cookiecutter.project_slug }}.inference.api._model", None)
