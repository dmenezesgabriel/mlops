from ssg.application.html_headings import (
...
def test_article_outline_builder_adds_stable_heading_anchors() -> None:
    ...
    assert [
        (heading.label, heading.href, heading.level)
...
def test_article_outline_builder_preserves_existing_ids_and_deduplicates_slugs() -> (
    None
):
    # Arrange
    rendered_html = (
        '<h2 id="custom">Overview</h2><h2>Overview</h2><h2>Overview</h2>'
    )
